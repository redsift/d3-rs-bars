...
export var scripts = {"serve":"gulp -o d3-rs-bars -g d3-selection -g d3-array -g d3-scale -g d3-axis serve","build":"gulp -o d3-rs-bars -g d3-selection -g d3-array -g d3-scale -g d3-axis build","pretest":"npm outdated && npm run version && npm run build","test":"tape 'test/**/*-test.js' && eslint index.js src","version":"json2module package.json > package.js","prepublish":"npm run version && npm run build"};
export var dependencies = {"d3-selection":"^0.9.0","d3-array":"^1.0.0","d3-scale":"^0.9.2","d3-axis":"^0.4.1","@redsift/d3-rs-svg":"~0.2.3","@redsift/d3-rs-theme":"~0.0.1","@redsift/d3-rs-tip":"~0.2.1"};
